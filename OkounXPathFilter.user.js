// ==UserScript==
// @name         Echelon's okoun xpath filter
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Filtr ritnych.dier na okounu
// @author       You
...
(function() {
    ...
    let xPath = '//div[@class=\'list posted-item-list articles\']/div/div/span[@class=\'user\' and (text() = \'' + ultradebilove[0] + '\'';
